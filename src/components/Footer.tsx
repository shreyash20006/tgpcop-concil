      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <ul className="grid grid-cols-2 gap-3 text-sm text-white/70">
              ...
              <li>
                <Link to="/achievements" className="hover:text-orange-burnt transition-colors">🏆 Achievements</Link>
              </li>
              <li>
                <Link to="/vote" className="hover:text-orange-burnt transition-colors">🗳️ Vote/Polls</Link>
              </li>
              <li>
                <Link to="/mentors" className="hover:text-orange-burnt transition-colors">🤝 Mentorship</Link>
              </li>
              <li>
                <Link to="/newsletter" className="hover:text-orange-burnt transition-colors">📰 Newsletters</Link>
              </li>
              <li className="col-span-2">
                <Link to="/complaint" className="hover:text-orange-burnt transition-colors text-red-300 font-semibold">🆘 Anonymous Complaint</Link>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/10 pt-8 mt-8 flex flex-col md:flex-row items-center justify-between text-xs text-white/50 space-y-4 md:space-y-0">
          <p className="flex flex-wrap items-center gap-2">
            ...
            <span className="text-white/25 hidden sm:inline">|</span>
            <Link to="/complaint" className="hover:text-orange-burnt transition-colors font-semibold tracking-wide text-red-300">
