          ...
          <div className="space-y-6">
            ...
            <div className="text-center space-y-2">
              <p className="text-white/70 text-xs font-sans">
                "Use your registered college Google account"
              </p>
              <p className="text-amber-500/90 text-[10px] font-bold uppercase tracking-wider leading-relaxed">
                ⚠️ Only authorized executive emails can login
              </p>
            </div>
          </div>
        </div>
